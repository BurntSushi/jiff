...
| Timestamp | Description | Jiff support? |
| --------- | ----------- | ------------- |
| `2025-03-07T15:27:00-05:00[America/New_York]` | Timestamp in New York | Yes |
...
transition of an entire set of rules for calculating local time. This is best
...
assert_eq!(
    ...
    // equivalent to 2025-08-20T22:00
    "2025-08-20T17:00:00-05:00[-05:00]",
);
assert_eq!(
    (&zdt_tz + 6.months()).to_string(),
    // equivalent to 2025-08-20T21:00
...
Indeed, this is why RFC 9557 specifically says this about offset time zones:
