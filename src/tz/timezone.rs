...
mod repr {
    ...
    impl Repr {
        ...
        pub(super) const fn static_tzif(tzif: &'static TzifStatic) -> Repr {
            assert!(core::mem::align_of::<TzifStatic>() >= 4);
        ...
        pub(super) fn arc_tzif(tzif: Arc<TzifOwned>) -> Repr {
            assert!(core::mem::align_of::<TzifOwned>() >= 4);
        ...
        pub(super) fn arc_posix(
            ...
            assert!(core::mem::align_of::<ReasonablePosixTimeZone>() >= 4);
        ...
        pub(super) unsafe fn get_fixed(&self) -> Offset {
            ...
            let seconds = t::SpanZoneOffset::new_unchecked((addr >> 4) as i32);
