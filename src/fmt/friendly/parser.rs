...
mod tests {
    ...
    fn parse_duration_boundaries() {
        ...
        insta::assert_snapshot!(
            ...
            @r###"failed to parse "2562047788015216hrs" in the "friendly" format: parsed 9223372036854777600000000000 nanoseconds, but overflows 64-bit seconds: parameter 'seconds' with value 9223372036854777600 is not in the required range of -9223372036854775808..=9223372036854775807"###,
        );
        ...
        insta::assert_snapshot!(
            ...
            @r###"failed to parse "153722867280912931mins" in the "friendly" format: parsed 9223372036854775860000000000 nanoseconds, but overflows 64-bit seconds: parameter 'seconds' with value 9223372036854775860 is not in the required range of -9223372036854775808..=9223372036854775807"###,
        );
        ...
        insta::assert_snapshot!(
            ...
            @r###"failed to parse "9223372036854775808s" in the "friendly" format: failed to parse "9223372036854775808" as 64-bit signed integer: number '9223372036854775808' too big to parse into 64-bit integer"###,
        );
        insta::assert_snapshot!(
            pe("-9223372036854775808s"),
            @r###"failed to parse "-9223372036854775808s" in the "friendly" format: failed to parse "9223372036854775808" as 64-bit signed integer: number '9223372036854775808' too big to parse into 64-bit integer"###,
    ...
    fn err_duration_overflow_fraction() {
        ...
        insta::assert_snapshot!(
            ...
            @r###"failed to parse "9223372036854775808 micros" in the "friendly" format: failed to parse "9223372036854775808" as 64-bit signed integer: number '9223372036854775808' too big to parse into 64-bit integer"###,
        );
        // one fewer is okay
        insta::assert_snapshot!(
