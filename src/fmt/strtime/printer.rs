...
mod tests {
    ...
    fn ok_format_compound_uppercase() {
        ...
        insta::assert_snapshot!(f("%^c", date(2024, 7, 14).at(0, 0, 0, 0)), @"2024 M07 14, SUN 00:00:00");
        insta::assert_snapshot!(f("%^x", date(2024, 7, 14).at(0, 0, 0, 0)), @"2024 M07 14");
        insta::assert_snapshot!(f("%^X", date(2024, 7, 14).at(8, 30, 0, 0)), @"08:30:00");
        insta::assert_snapshot!(f("%^r", date(2024, 7, 14).at(8, 30, 0, 0)), @"8:30:00 AM");
    }
